...
export class Search {
	...
	getResultByTag(tag, tagsList) {
		// console.log('Get result by tag', this.searchResultArray);
		localStorage.clear();
		if(tag) {
